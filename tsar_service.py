...
const GAME={kind:null, root:null, files:null, stored:null, name:"", my:new Set(), visited:new Set(),
            ...
            ini:null, needIni:false, iniCached:false};
...
async function disconnectGame(){
  ...
  Object.assign(GAME,{kind:null,root:null,files:null,stored:null,name:"",ini:null,needIni:false,iniCached:false,my:new Set(),visited:new Set(),types:{},parent:{},models:{},states:{},stateId:{},wags:{},saved:{}});
  resetRrIds();
